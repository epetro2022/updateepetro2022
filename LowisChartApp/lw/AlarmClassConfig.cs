...
{
    public partial class AlarmClassConfig : DevExpress.XtraEditors.XtraUserControl
    {
        DB dbCon;
        public AlarmClassConfig()
        {
            InitializeComponent();
        ...
        private void AlarmClassConfig_Load(object sender, EventArgs e)
        {
            dbCon.clearCache();
            Dictionary<string, object> paras = new Dictionary<string, object>();
            paras.Add("@param", "");
            DataSet ds = dbCon.execprosedure("dbo.[prosedur_getdataEspalarmclassconfig]", paras);
