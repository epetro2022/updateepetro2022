...
{
    public partial class DiscreteStatus : DevExpress.XtraEditors.XtraUserControl
    {
        DB dbCon;
        frmMain frm;
        public DiscreteStatus()
        {
            InitializeComponent();
        ...
        private void DiscreteStatus_Load(object sender, EventArgs e)
        {
            dbCon.clearCache();
