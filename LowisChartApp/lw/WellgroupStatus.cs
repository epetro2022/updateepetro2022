...
{
    public partial class WellgroupStatus : DevExpress.XtraEditors.XtraUserControl
    {
        DB dbCon;
        public WellgroupStatus()
        {
            InitializeComponent();
        ...
        private void WellgroupStatus_Load(object sender, EventArgs e)
        {
            dbCon.clearCache();
