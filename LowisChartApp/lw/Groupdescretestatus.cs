...
{
    public partial class Groupdescretestatus : DevExpress.XtraEditors.XtraUserControl
    {
        DB dbCon;
        public Groupdescretestatus()
        {
            InitializeComponent();
        ...
        private void Groupdescretestatus_Load(object sender, EventArgs e)
        {
            dbCon.clearCache();
            Dictionary<string, object> paras = new Dictionary<string, object>();
            paras.Add("@param", "");
            DataSet ds = dbCon.execprosedure("dbo.[prosedur_getdataGroupdescretestatus]", paras);
