...
{
    public partial class GroupDescreteConfig : DevExpress.XtraEditors.XtraUserControl
    {
        DB dbCon;
        public GroupDescreteConfig()
        {
            InitializeComponent();
        ...
        private void GroupDescreteConfig_Load(object sender, EventArgs e)
        {
            dbCon.clearCache();
            Dictionary<string, object> paras = new Dictionary<string, object>();
            paras.Add("@param", "");
            DataSet ds = dbCon.execprosedure("dbo.[prosedur_getdataGroupDescreteConfig]", paras);
