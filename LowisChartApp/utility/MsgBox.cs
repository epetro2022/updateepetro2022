        ...
        private static PictureBox Picture(Icon icon)
        {
            ...
            switch (icon)
            {
                ...
                case Icon.Exclamation:
                    stream = assembly.GetManifestResourceStream(@"exclamation.png");
                    break;
                case Icon.Information:
                    stream = assembly.GetManifestResourceStream(@"information.png");
                    break;
                case Icon.Question:
                    stream = assembly.GetManifestResourceStream(@"question.png");
                    break;
                case Icon.Nothing:
                    stream = assembly.GetManifestResourceStream(@"LowisChartApp.utility.nic80x80.png");
                    break;
            }
